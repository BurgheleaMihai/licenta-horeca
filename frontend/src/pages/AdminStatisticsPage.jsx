...
const isTimestampInFilters = (timestamp, filters) => {
  if (!timestamp) {
    return false;
  }
...
function AdminStatisticsPage() {
  ...
  const [customStartDate, setCustomStartDate] = useState(todayValue);

  const [customEndDate, setCustomEndDate] = useState(todayValue);
  ...
  const handleResetFilters = () => {
    const currentDate = getLocalDateValue(new Date());
  ...
  return (
    <div className="admin-statistics-page">
      ...
      <section className="admin-statistics-section">
        ...
        <form className="admin-statistics-filter" onSubmit={handleFilterSubmit}>
      ...
      <section className="admin-statistics-section">
        ...
        ) : statistics.productSalesList.length === 0 ? (
          <p>Nu exista produse vandute in perioada selectata.</p>
        ) : (
          <div className="admin-statistics-grid">
            {statistics.productSalesList.slice(0, 10).map((product, index) => (
      ...
      <section className="admin-statistics-section">
        ...
        <p>
          Comenzile servite si veniturile sunt filtrate dupa momentul
          finalizarii comenzii.
        </p>
