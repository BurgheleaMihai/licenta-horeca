...
class TableSessionControllerTest {
    ...
    private static final String ACTIVE_SESSIONS_ENDPOINT = "/api/table-sessions/active";
    private static final String CREATE_SESSION_ENDPOINT = "/api/table-sessions/table/3";
    ...
    void getActiveSessionsShouldReturnActiveSessions() throws Exception {
        ...
        when(tableSessionService.getActiveSessions())
    ...
    void createSessionForTableShouldReturnCreatedSession() throws Exception {
        ...
        when(tableSessionService.createSessionForTable(3L))
                .thenReturn(session);
