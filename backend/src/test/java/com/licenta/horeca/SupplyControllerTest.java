...
class AuxiliarySupplyControllerTest {
    ...
    private static final String UNAVAILABLE_SUPPLIES_ENDPOINT = "/api/auxiliary-supplies/unavailable";
    private static final String MARK_UNAVAILABLE_ENDPOINT = "/api/auxiliary-supplies/1/mark-unavailable";
    private static final String MARK_AVAILABLE_ENDPOINT = "/api/auxiliary-supplies/1/mark-available";
    ...
    void markUnavailableShouldReturnUnavailableSupply() throws Exception {
        ...
        when(auxiliarySupplyService.markUnavailable(1L))
                .thenReturn(cups);
    ...
    void markAvailableShouldReturnAvailableSupply() throws Exception {
        ...
        when(auxiliarySupplyService.markAvailable(1L))
                .thenReturn(cups);
